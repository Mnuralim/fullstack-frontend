...
export default function Home() {
  ...
  const imageProduct1 = [
    { id: 1, src: "/img/image 1168.png", alt: "Image 1" },
    { id: 2, src: "/img/image 1.png", alt: "Image 2" },
    { id: 3, src: "/img/image 1169.png", alt: "Image 3" },
    { id: 4, src: "/img/image 3.png", alt: "Image 3" },
  ];

  const imageProduct2 = [
    { id: 1, src: "/img/image 1.png", alt: "Image 2" },
    { id: 2, src: "/img/image 1168.png", alt: "Image 1" },
    { id: 3, src: "/img/image 1169.png", alt: "Image 3" },
    { id: 4, src: "/img/image 3.png", alt: "Image 3" },
  ];
  const imageProduct3 = [
    { id: 1, src: "/img/image 1169.png", alt: "Image 1" },
    { id: 2, src: "/img/image 1.png", alt: "Image 2" },
    { id: 3, src: "/img/image 1168.png", alt: "Image 3" },
    { id: 4, src: "/img/image 3.png", alt: "Image 3" },
  ];
  const imageProduct4 = [
    { id: 1, src: "/img/image 3.png", alt: "Image 3" },
    { id: 2, src: "/img/image 1169.png", alt: "Image 1" },
    { id: 3, src: "/img/image 1.png", alt: "Image 2" },
    { id: 4, src: "/img/image 1168.png", alt: "Image 3" },
  ];
        ...
        <div className="w-full px-[150px]">
          ...
          <div className="flex gap-[30px] justify-center">
            ...
            <div className="w-[270px] h-[361px] shadow-md rounded overflow-hidden relative group flex justify-center">
              <div className="bg-[#F6F7FB] w-[270px] h-[236px] relative  z-20">
                <div className="relative transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                  <div className="text-[#1389FF] text-[14px] flex justify-start px-[15px] pt-3 gap-5 absolute z-10  -left-44 group-hover:left-0 transition-all duration-500">
                    <div className="">
                      <Link className=" py-[10px] bg-transparent  px-[10px] rounded-full prod-icon " href={"/"}>
                        <ShoppingCartOutlinedIcon />
